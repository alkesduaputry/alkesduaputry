<script lang="ts">
	import { portfolioItems, whatsappBase } from '$lib/data/products';
</script>
...
<section class="section">
	<div class="container">
		...
		<p class="section-copy">
			Kebutuhan yang kami dukung mencakup pengadaan hospital furniture, trolley medis, lemari
			instrumen, dan peralatan penunjang ruang klinik atau rumah sakit.
		</p>
		<div class="grid">
		...
		<div class="button-row">
			<a class="btn btn-primary" href={whatsappBase} target="_blank" rel="noreferrer">Diskusikan Kebutuhan Anda</a>
		</div>
	</div>
</section>
